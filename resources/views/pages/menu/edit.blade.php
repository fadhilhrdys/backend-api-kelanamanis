...
<div class="col-sm-8 px-0">
    ...
    <div class="row">
        <form action="{{ route('menu.update', $menus->id) }}" method="post" class="col form-add-menu py-3"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"
                    value="{{ old('name') ? old('name') : $menus->name }}">
                @error('name')
            ...
            <div class="form-group">
                ...
                <div class="price d-flex align-items-center">
                    ...
                    <input type="number" class="form-control @error('price') is-invalid @enderror" id="price"
                        name="price" value="{{ old('price') ? old('price') : $menus->price }}">
                </div>
                @error('price')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            ...
            <div class=" form-group">
                ...
                <div class="input-photo text-center">
                    <label class="input-photo text-center" for="photo">
                        ...
                        <input type="file" class="@error('photo') is-invalid @enderror" id="photo" name="photo" hidden>
